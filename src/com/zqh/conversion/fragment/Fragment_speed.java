...
public class Fragment_speed extends Fragment implements OnItemSelectedListener {
	private View view;
	...
	public View onCreateView(LayoutInflater inflater,
		...
		et = (EditText) view.findViewById(R.id.et_input_speed);
		et.setInputType(InputType.TYPE_NULL);// 不弹出输入法
		mySpinner_top = (Spinner) view.findViewById(R.id.spinner_top_speed);
		mySpinner = (Spinner) view.findViewById(R.id.spinner_speed);
		tv=(TextView) view.findViewById(R.id.tv_result_speed);
	...
	public class numberBroadcasReceiver extends BroadcastReceiver {
		...
		public void onReceive(Context context, Intent intent) {
			...
			if (intent.getAction().equals("zqh.number.0")) {
				...
				float output=changeUnit.ChangetoUnitspeed(unit, result, unit2);
