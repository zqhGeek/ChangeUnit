...
public class Fragment_temperature extends Fragment implements OnItemSelectedListener {
	private View view;
	...
	public View onCreateView(LayoutInflater inflater,
		...
		view = inflater.inflate(R.layout.temperature, container, false);
		et = (EditText) view.findViewById(R.id.et_input_temperature);
		et.setInputType(InputType.TYPE_NULL);// 不弹出输入法
		mySpinner_top = (Spinner) view.findViewById(R.id.spinner_top_temperature);
		mySpinner = (Spinner) view.findViewById(R.id.spinner_temperature);
		tv=(TextView) view.findViewById(R.id.tv_result_temperature);
	...
	public class numberBroadcasReceiver extends BroadcastReceiver {
		...
		public void onReceive(Context context, Intent intent) {
			...
			if (intent.getAction().equals("zqh.number.0")) {
				...
				float output=changeUnit.ChangetoUnittemperature(unit, result, unit2);
