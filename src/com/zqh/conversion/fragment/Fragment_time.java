...
public class Fragment_time extends Fragment implements OnItemSelectedListener {
	private View view;
	...
	public View onCreateView(LayoutInflater inflater,
		...
		et = (EditText) view.findViewById(R.id.et_input_time);
		et.setInputType(InputType.TYPE_NULL);// 不弹出输入法
		mySpinner_top = (Spinner) view.findViewById(R.id.spinner_top_time);
		mySpinner = (Spinner) view.findViewById(R.id.spinner_time);
		tv=(TextView) view.findViewById(R.id.tv_result_time);
	...
	public class numberBroadcasReceiver extends BroadcastReceiver {
		...
		public void onReceive(Context context, Intent intent) {
			...
			if (intent.getAction().equals("zqh.number.0")) {
				...
				float output=changeUnit.ChangetoUnittime(unit, result, unit2);
