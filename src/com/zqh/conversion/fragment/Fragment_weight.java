...
public class Fragment_weight extends Fragment implements OnItemSelectedListener {
	private View view;
	...
	public View onCreateView(LayoutInflater inflater,
		...
		view = inflater.inflate(R.layout.weight, container, false);
		et = (EditText) view.findViewById(R.id.et_input_weight);
		et.setInputType(InputType.TYPE_NULL);// 不弹出输入法
		mySpinner_top = (Spinner) view.findViewById(R.id.spinner_top_weight);
		mySpinner = (Spinner) view.findViewById(R.id.spinner_weight);
		tv=(TextView) view.findViewById(R.id.tv_result_weight);
	...
	public class numberBroadcasReceiver extends BroadcastReceiver {
		...
		public void onReceive(Context context, Intent intent) {
			...
			if (intent.getAction().equals("zqh.number.0")) {
				...
				float output=changeUnit.ChangetoUnitweight(unit, result, unit2);
