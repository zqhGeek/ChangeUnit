...
public class Fragment_volume extends Fragment implements OnItemSelectedListener {
	private View view;
	...
	public View onCreateView(LayoutInflater inflater,
		...
		view = inflater.inflate(R.layout.volume, container, false);
		et = (EditText) view.findViewById(R.id.et_input_volume);
		et.setInputType(InputType.TYPE_NULL);// 不弹出输入法
		mySpinner_top = (Spinner) view.findViewById(R.id.spinner_top_volume);
		mySpinner = (Spinner) view.findViewById(R.id.spinner_volume);
		tv=(TextView) view.findViewById(R.id.tv_result_volume);
	...
	public class numberBroadcasReceiver extends BroadcastReceiver {
		...
		public void onReceive(Context context, Intent intent) {
			...
			if (intent.getAction().equals("zqh.number.0")) {
				...
				float output=changeUnit.ChangetoUnitvolume(unit, result, unit2);
